...
plan.W_X =        np.array([1e+3, 1e-5, 1e+5, 1e-4, 1e-4, 1e-4, 3e+3, 5e+2, 3e+3])
plan.W_X_ter = 10*np.array([1e+5, 1e+5, 1e+5, 1e-1, 1e-1, 1e-1, 1e+2, 5e+3, 1e+2])
plan.W_F = np.array(2*[1e+1, 1e+1, 1e+0] + 2*[1e+1, 1e+1, 2e+0])
plan.rho = 5e+4

plan.X_nom = [[0.2, 0, 0.22, 0, 0, 0, 0, 0.0, 0., 0, st],
              [0.2, 0, 0.35, 0, 0, 0, 0, 0.0, 0., st, st+rt],
              [0.2, 0, 0.35, 0, 0, 0, 0, 0.0, 0., st+rt, st+rt+jt],
              [0.2, 0, 0.22, 0, 0, 0, 0, 0.0, 0., st+rt+jt, T]]
...
state_wt_1 = np.array([1e-2, 1e-2, 1e-2] + [10, 1, 10] + 4*[1e+2, 1e+2, 1e+2] \
