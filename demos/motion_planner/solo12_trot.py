...
# weights
W_X = np.array([1e-5, 1e-5, 1e-5, 1e-4, 1e-4, 1e-4, 1e-4, 1e-4, 1e-4])
W_X_ter = np.array([1e+5, 1e+5, 1e+5, 1e+4, 1e+4, 1e+4, 1e+4, 1e+4, 1e+4])

W_F = np.array(4*[1e-1, 1e-1, 5e-1])

rho = 1e-6 # penalty on dynamic constraint violation
...
# print(mp.q_X[0:9])
X_opt, F_opt, mom_opt = mp.optimize(X_init, 15)
# print(F_opt[2::3])
mp.stats()
