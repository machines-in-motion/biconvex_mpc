...
plan.cnt_plan = [[[ 1., HC_init_x, -MC_init_out_y,  0., 0.,  stance_time],
                 ...
                 [[ 1., HC_init_x + jump_length, -MC_init_out_y,  0., stance_time+flight_time,  plan.T],
                  [ 1., TC_init_x + jump_length, -MC_init_out_y,  0., stance_time+flight_time,  plan.T],
                  [ 1., HC_init_x + jump_length, -MC_init_in_y ,  0., stance_time+flight_time,  plan.T],
                  [ 1., TC_init_x + jump_length, -MC_init_in_y ,  0., stance_time+flight_time,  plan.T],
                  [ 1., HC_init_x + jump_length,  MC_init_in_y ,  0., stance_time+flight_time,  plan.T],
                  [ 1., TC_init_x + jump_length,  MC_init_in_y ,  0., stance_time+flight_time,  plan.T],
                  [ 1., HC_init_x + jump_length,  MC_init_out_y,  0., stance_time+flight_time,  plan.T],
                  [ 1., TC_init_x + jump_length,  MC_init_out_y,  0., stance_time+flight_time,  plan.T]]]
...
plan.W_X_ter = 10.*np.array([2e5, 1e5, 1e+5, 1e-1, 1e-1, 2e2, 1e+5, 1e+5, 1e+5])
...
plan.X_nom = [[jump_length/3., 0, 0.4, 0, 0, 0, 0, 0.00, 0.0, 0.0, stance_time],
              ...
              [jump_length, 0., 0.9, 0, 0, 0, 0, 0.0, 0., stance_time+flight_time, plan.T]]

plan.X_ter = [jump_length, 0., 0.9, 0, 0, 0, 0, 0.0, 0.0]
plan.bounds = [[-0.5, -0.5, .3, 0.75, 0.75, 2., 0., plan.T]]
