...
balance.ctrl_wt = [0, 0, 1000] + [5e2, 5e2, 5e2] + [50.0] * (29) # Penalty on control (aka accelerations)

# Centroidal
balance.cent_wt = [5e+5, 3e+1] #Center of Mass, Momentum
balance.nom_ht = 1.1
