...
# IK
trot.state_wt = np.array([0., 0, 10] + [1000, 1000, 1000] + [10.0] * (12) \
                         + [0.00] * 3 + [100, 100, 100] + [5.0] *(12))

trot.ctrl_wt = [0, 0, 1000] + [5e2, 5e2, 5e2] + [4.0] *(12)
...
# Dyn
trot.W_X =        np.array([3e-3, 3e-3, 1e+5, 1e+3, 1e+1, 2e+2, 1e+4, 1e+5, 1e4])
