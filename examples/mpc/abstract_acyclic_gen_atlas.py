...
class AtlasAcyclicGen:
    ...
    def __init__(self, robot, r_urdf):
        ...
        self.eff_names = ["l_foot_lt", "l_foot_rt", "l_foot_lb", "l_foot_rb", "r_foot_lt", "r_foot_rt", "r_foot_lb", "r_foot_rb"]
        self.n_eff = 8
        self.ee_frame_id = []
    ...
    def create_contact_plan(self, q, v, t, make_cyclic = False):
        ...
        print("com:",pin.centerOfMass(self.rmodel, self.rdata, q, np.zeros(self.rmodel.nv)))
