...
plan.cnt_plan = [[[ 1., HC_init_x, -MC_init_y,  0., 0.,  DSP_time],
                  [ 1., TC_init_x, -MC_init_y,  0., 0.,  DSP_time],
                  [ 1., HC_init_x,  MC_init_y,  0., 0.,  DSP_time],
                  [ 1., TC_init_x,  MC_init_y,  0., 0.,  DSP_time]],

                 [[ 0., HC_init_x, -MC_init_y,  0., DSP_time, DSP_time + SSP_time],
                  [ 0., TC_init_x, -MC_init_y,  0., DSP_time, DSP_time + SSP_time],
                  [ 1., HC_init_x,  MC_init_y,  0., DSP_time, DSP_time + SSP_time],
                  [ 1., TC_init_x,  MC_init_y,  0., DSP_time, DSP_time + SSP_time]],

                 [[ 1., HC_init_x+step_length, -MC_init_y,  0., DSP_time + SSP_time, 2*DSP_time + SSP_time ],
                  [ 1., TC_init_x+step_length, -MC_init_y,  0., DSP_time + SSP_time, 2*DSP_time + SSP_time ],
                  [ 1., HC_init_x,              MC_init_y,  0., DSP_time + SSP_time, 2*DSP_time + SSP_time ],
                  [ 1., TC_init_x,              MC_init_y,  0., DSP_time + SSP_time, 2*DSP_time + SSP_time ]],

                 [[ 1., HC_init_x+step_length, -MC_init_y,  0., 2*DSP_time + SSP_time, 2*(DSP_time + SSP_time)],
                  [ 1., TC_init_x+step_length, -MC_init_y,  0., 2*DSP_time + SSP_time, 2*(DSP_time + SSP_time)],
                  [ 0., HC_init_x,              MC_init_y,  0., 2*DSP_time + SSP_time, 2*(DSP_time + SSP_time)],
                  [ 0., TC_init_x,              MC_init_y,  0., 2*DSP_time + SSP_time, 2*(DSP_time + SSP_time)]],

                 [[ 1., HC_init_x+step_length, -MC_init_y,  0., 2*(DSP_time + SSP_time), plan.T ],
                  [ 1., TC_init_x+step_length, -MC_init_y,  0., 2*(DSP_time + SSP_time), plan.T ],
                  [ 1., HC_init_x+step_length,  MC_init_y,  0., 2*(DSP_time + SSP_time), plan.T ],
                  [ 1., TC_init_x+step_length,  MC_init_y,  0., 2*(DSP_time + SSP_time), plan.T ]]]
...
plan.swing_wt = [[[10., step_length/2, -MC_init_y,  0.2, DSP_time+.6*SSP_time, DSP_time+.7*SSP_time],
                  [10., step_length/2, -MC_init_y,  0.2, DSP_time+.6*SSP_time, DSP_time+.7*SSP_time],
                  [0., step_length/2,  MC_init_y,  0.0, DSP_time+.6*SSP_time, DSP_time+.7*SSP_time],
                  [0., step_length/2,  MC_init_y,  0.0, DSP_time+.6*SSP_time, DSP_time+.7*SSP_time]],

                 [[0., step_length/2, -MC_init_y,  0.0, 2*DSP_time+1.4*SSP_time, 2*DSP_time+1.5*SSP_time],
                  [0., step_length/2, -MC_init_y,  0.0, 2*DSP_time+1.4*SSP_time, 2*DSP_time+1.5*SSP_time],
                  [0.1, step_length/2,  MC_init_y, 0.2, 2*DSP_time+1.4*SSP_time, 2*DSP_time+1.5*SSP_time],
                  [0.1, step_length/2,  MC_init_y, 0.2, 2*DSP_time+1.4*SSP_time, 2*DSP_time+1.5*SSP_time]]]
plan.cent_wt = [100., .01]
plan.cnt_wt = 5e3
