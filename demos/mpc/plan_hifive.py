...
plan.W_X =        np.array([1e+5, 1e-3, 1e+5, 1e+1, 1e+1, 2e-4, 1e+4, 1e+2, 1e+4])
plan.W_X_ter = 10*np.array([1e+2, 1e-3, 1e+3, 1e+1, 1e+1, 2e-4, 1e+5, 1e+2, 1e+5])
plan.W_F = np.array(4*[1e+1, 1e+1, 1e-2])
plan.rho = 5e+4

plan.X_nom = [[0.2, 0, 0.22, 0, 0, 0, 0, 0.0, 0., 0, st],
              [0.2, 0, 0.3, 0, 0, 0, 0, 0.0, 0., st, st+rt],
...
plan.cent_wt = [1e1, 1e2]
plan.cnt_wt = 1e4
plan.swing_wt = [[[1e2, 0.3946,   0.14695,  0.2, st + 0.25*rt, st + 0.5*rt],
...
state_wt_1 = np.array([1e-2, 1e-2, 0] + [100, 100, 100] + 4*[1e1, 50.0, 20] \
