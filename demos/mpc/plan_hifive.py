...
plan.W_X =        np.array([1e-5, 1e-5, 1e-5, 1e-4, 1e-4, 1e-4, 3e+3, 3e+3, 3e+3])
plan.W_X_ter = 10*np.array([1e+5, 1e+5, 1e+5, 1e+5, 1e+5, 1e+5, 1e+5, 1e+5, 1e+5])
plan.W_F = np.array(4*[1e+1, 1e+1, 1e-1])
plan.rho = 5e+4

plan.X_nom = [[0.2, 0, 0.22, 0, 0, 0, 0, 0.0, 0., 0, st],
              [0.2, 0, 0.32, 0, 0, 0, 0, 0.0, 0., st, st+rt],
...
state_wt_1 = np.array([1e-2, 1e-2, 0] + [100, 1, 100] + 4*[1e1, 1e2, 1e2] \
